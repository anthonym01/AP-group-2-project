...
public class MakeQueryPanel extends JPanel {
    ...
    public MakeQueryPanel(Controller controller) {
        super();
    ...
    private void initComponents(){
        form = new SubmissionForm("make a query", controller);

        // Labels
        formNameLabel = new JLabel("Make a Query Form", SwingConstants.CENTER);
