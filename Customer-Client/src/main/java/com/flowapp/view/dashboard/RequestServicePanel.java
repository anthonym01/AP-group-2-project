...
public class RequestServicePanel extends JPanel {
    ...
    public RequestServicePanel(Controller controller) {
        super();
    ...
    private void initComponents(){
        form = new SubmissionForm("request a service", controller);

        // Labels
        formNameLabel = new JLabel("Request a Service Form", SwingConstants.CENTER);
