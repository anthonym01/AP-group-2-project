...
public class EmpViewSubmissionsPanel extends JPanel {
    ...
    public EmpViewSubmissionsPanel(Controller controller) {
        super();
    ...
    public void setMessages(List<Message> messages, String category) {
        ...
        String basicInfo = (category != null ? "Results for \"" + category + "\"": "Messages");
        updateSubmissionsPanelInfo(basicInfo);
    }
    ...
    private void initComponents(){
        // Labels
        basicInfoLabel = new JLabel("Messages (0)", SwingConstants.CENTER);
        ...
        messageTablePanel = new EmpMessageTablePanel("representative");
    ...
    private void updateSubmissionsPanelInfo(String basicInfo){
        messageTablePanel.setMessages(messages);

        basicInfoLabel.setText(basicInfo + " (" + messages.size() + ")");
